...
PATH_vae = model_save_dir + '/betaVAE_l_{}_input_{}_lr_{}'.format(latent_dim, img_size, learning_rate)
...
def plot_reconstruction():
    ...
    if os.path.exists(results_save_dir + '/anom_scores_normal_l_{}_input_{}_lr_{}.npy'.format(latent_dim, img_size, learning_rate)) and \
        os.path.exists(results_save_dir + '/anom_scores_seizure_l_{}_input_{}_lr_{}.npy'.format(latent_dim, img_size, learning_rate)) and \
        os.path.exists(results_save_dir + '/recon_normal_l_{}_input_{}_lr_{}.npy'.format(latent_dim, img_size, learning_rate)) and \
        os.path.exists(results_save_dir + '/recon_seizure_l_{}_input_{}_lr_{}.npy'.format(latent_dim, img_size, learning_rate)) :#and \
        #    os.path.exists(results_save_dir + '/latent_tsne_l_{}_input_{}_lr_{}.npy'.format(latent_dim, img_size, learning_rate)):
        anom_scores_normal = np.load(results_save_dir + '/anom_scores_normal_l_{}_input_{}_lr_{}.npy'.
                                     format(latent_dim, img_size, learning_rate))
        anom_scores_seizure = np.load(results_save_dir + '/anom_scores_seizure_l_{}_input_{}_lr_{}.npy'.
                                      format(latent_dim, img_size, learning_rate))
        recon_normal = np.load(results_save_dir + '/recon_normal_l_{}_input_{}_lr_{}.npy'.
                                     format(latent_dim, img_size, learning_rate))
        recon_seizure = np.load(results_save_dir + '/recon_seizure_l_{}_input_{}_lr_{}.npy'.
                                      format(latent_dim, img_size, learning_rate))
        ...
        np.save(results_save_dir + '/anom_scores_normal_l_{}_input_{}_lr_{}.npy'.
                format(latent_dim, img_size, learning_rate), anom_scores_normal)
        np.save(results_save_dir + '/anom_scores_seizure_l_{}_input_{}_lr_{}.npy'.
                format(latent_dim, img_size, learning_rate), anom_scores_seizure)
        np.save(results_save_dir + '/recon_normal_l_{}_input_{}_lr_{}.npy'.
                format(latent_dim, img_size, learning_rate), recon_normal)
        np.save(results_save_dir + '/recon_seizure_l_{}_input_{}_lr_{}.npy'.
                format(latent_dim, img_size, learning_rate), recon_seizure)
    """
    ...
    plt.savefig(results_save_dir + '/latent_seizure_3D_l_{}_input_{}_lr_{}.pdf'.format(latent_dim, img_size, learning_rate), bbox_inches='tight')
    plt.close()
    """
    ...
    plt.savefig(results_save_dir + '/anom_hist_l_{}_input_{}_lr_{}.pdf'.format(latent_dim, img_size, learning_rate), bbox_inches='tight')
    plt.close()
    ...
    plt.savefig(results_save_dir + '/true_positive_l_{}_input_{}_lr_{}.pdf'.format(latent_dim, img_size, learning_rate),
                bbox_inches='tight')
    plt.close()
    ...
    axs[1, 0].set(xlabel=r'Time (s)')
    axs[1, 1].set(xlabel=r'Time (s)')
    plt.savefig(results_save_dir + '/false_positive_l_{}_input_{}_lr_{}.pdf'.format(latent_dim, img_size, learning_rate),
                bbox_inches='tight')
    plt.close()
    ...
    axs[1, 0].set(xlabel=r'Time (s)')
    axs[1, 1].set(xlabel=r'Time (s)')
    plt.savefig(results_save_dir + '/true_negative_l_{}_input_{}_lr_{}.pdf'.format(latent_dim, img_size, learning_rate),
                bbox_inches='tight')
    plt.close()
    ...
    axs[1, 0].set(xlabel=r'Time (s)')
    axs[1, 1].set(xlabel=r'Time (s)')
    plt.savefig(results_save_dir + '/false_negative_l_{}_input_{}_lr_{}.pdf'.format(latent_dim, img_size, learning_rate),
                bbox_inches='tight')
    plt.close()
